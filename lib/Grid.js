...
var vallidate = require('./vallidate');
...
module.exports = function Grid (initialWidth) {
  ...
  // TODO: do i care about grid level options?
  var grid = {
   ...
   *
   */
  var setOption = chainFn(function (option, value) {
   ...
   *
   */
  self.column = chainFn(function (width) {
   ...
   *
   */
  self.nest = chainFn(function (divisions) {
...
function vallidateStateChange (oldState, newState, expectations) {
  return vallidate(oldState, newState, expectations);
}
