 ...
 * TODO: make mini version for production builds
 *
 */
var Vallidator;
...
module.exports = Vallidator = function () {
  ...
  self.checkLink = function (newLink, workingNest, arguments) {
    ...
    if (previousLink === LINK_TYPE.NEST && workingNest.expects > 0) {
      currentDepth += 1;
      
    } else if (previousLink === LINK_TYPE.NEST) {
      currentDepth -= 1;

    } else if (newLink === LINK_TYPE.COLUMN && 
                      workingNest && 
